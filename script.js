...
const skillDescriptions = {
    python: "Разработка прикладного программного обеспечения на Python с помощью PyQt6 и Tkinter. Проведение занятий по программам: Основы языка программирования Python, Нейронные сети на Python, Python для анализа данных, Python для сдачи ЕГЭ по информатике и ИКТ.",
    r: "Разработка прикладного программного обеспечения с использованием Shiny на языке R. Проведение индивидуальных и групповых занятий по основам программирования на языке R. Обучение работе с ключевыми пакетами из экосистемы tidyverse. Выполнение анализа и визуализации данных, а также формулировка и проверка гипотез с использованием современных инструментов анализа на R.",
